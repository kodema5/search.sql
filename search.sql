...
-- a way to add//update new category/type of items to be searched upon
...
-- data
\if :local
    drop schema if exists search_ cascade;
\endif
create schema if not exists search_;
\ir src/search_/index.sql
